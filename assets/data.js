// Data Structures for Weeks, Days, Vocab and Grammar
        ...
        const makeImageVocabSet = (theme, entries) => ({
            theme,
            words: entries.map(([word, mean]) => ({
                word,
                pron: "Từ trong ảnh",
                pos: "TOEIC",
                mean,
                example: `Please review the term ${word} before the TOEIC test.`
            }))
        });

        const imageVocabDatabase = {
            Image37: makeImageVocabSet("Từ ảnh - Trang 37", [
                ["operate", "vận hành, hoạt động"], ["opportunity", "cơ hội"], ["beneficial", "có lợi"], ["personal", "cá nhân, riêng"], ["publish", "xuất bản"], ["charge", "phí, tính phí"], ["annual", "hằng năm"], ["package", "gói hàng, bưu kiện"], ["likely", "có khả năng, có thể"], ["enclose", "đính kèm"], ["material", "vật liệu, tài liệu"], ["cover", "trang bìa, nắp đậy, bao gồm"], ["state", "trạng thái, chỉ ra, đề cập"], ["session", "buổi họp, buổi huấn luyện"], ["access", "lối vào, quyền truy cập"], ["cause", "nguyên nhân, gây ra"], ["facility", "cơ sở, cơ sở vật chất"], ["regarding", "về, liên quan đến"], ["advance", "sự tiến lên, tiến bộ"], ["serve", "phục vụ"], ["record", "số liệu, ghi lại, lưu lại"], ["improve", "cải thiện"], ["appreciate", "cảm kích, đánh giá cao"], ["policy", "chính sách"], ["process", "quá trình, xử lý"], ["proposal", "bảng đề xuất, sự đề xuất"], ["propose", "đề xuất"], ["subscription", "hợp đồng đặt báo"], ["schedule", "lịch trình, sắp xếp"], ["conduct", "tiến hành"], ["profit", "lợi nhuận"], ["effective", "hiệu quả"], ["original", "ban đầu"], ["award", "giải thưởng"], ["describe", "mô tả"], ["concern", "sự lo lắng, mối lo"], ["perform", "thực hiện, biểu diễn"], ["invest", "đầu tư"], ["previous", "trước, trước đó"], ["variety", "sự đa dạng"], ["article", "bài báo"], ["item", "món đồ, món hàng"], ["available", "được cung cấp, sẵn có"], ["indicate", "chỉ ra"], ["promote", "quảng bá, thúc đẩy, thăng chức"], ["request", "sự yêu cầu, yêu cầu"], ["assistance", "sự hỗ trợ"], ["interest", "sự quan tâm, lãi suất"], ["industry", "ngành, công nghiệp"], ["suggest", "đề xuất"], ["reserve", "đặt chỗ"], ["out of", "hết, không còn"], ["manufacture", "sự sản xuất, sản xuất"], ["feature", "đặc tính, tính năng"], ["review", "sự đánh giá, xem lại"], ["consider", "xem xét"], ["exhibit", "trưng bày, triển lãm"], ["encourage", "khuyến khích"], ["rate", "giá, tỷ lệ"], ["submit", "nộp"], ["renovate", "tân trang, nâng cấp"], ["resident", "người dân"], ["limited", "bị giới hạn"], ["register", "đăng kí"], ["depart", "khởi hành, rời khỏi"], ["based on", "dựa trên"], ["notify", "thông báo"], ["approve", "chấp thuận"], ["approval", "sự chấp thuận"], ["renew", "gia hạn"], ["damage", "thiệt hại, hư hỏng"], ["agency", "công ty, tổ chức"], ["candidate", "ứng cử viên"], ["warranty", "sự bảo hành, giấy bảo hành"], ["inquire about", "hỏi về"], ["analysis", "sự phân tích"], ["permission", "sự cho phép"], ["representative", "người đại diện"], ["field", "lĩnh vực"], ["further", "thêm, thêm thông tin"]
            ]),
            Image38: makeImageVocabSet("Từ ảnh - Trang 38", [
                ["screening", "sàng lọc"], ["issue", "vấn đề, số báo, phát hành"], ["term", "điều khoản"], ["applicant", "người nộp đơn, ứng viên"], ["resume", "sơ yếu lý lịch"], ["happen", "xảy ra"], ["property", "tài sản, bất động sản"], ["specific", "cụ thể"], ["preference", "sự ưa chuộng"], ["deal with", "xử lý, đối mặt với"], ["condition", "điều kiện"], ["contribute", "đóng góp"], ["impress", "làm ấn tượng"], ["equipment", "thiết bị, dụng cụ"], ["distribute", "phân phối"], ["highly", "rất"], ["strategy", "chiến lược"], ["immediately", "ngay lập tức"], ["address", "địa chỉ, giải quyết"], ["avoid", "tránh"], ["expense", "chi phí"], ["branch", "chi nhánh"], ["performance", "hiệu suất làm việc, buổi biểu diễn"], ["receipt", "hóa đơn, biên nhận"], ["evaluate", "đánh giá"], ["launch", "tung ra, ra mắt"], ["in stock", "còn hàng"], ["attention", "sự chú ý"], ["significant", "đáng kể"], ["repair", "sửa chữa"], ["reform", "điều chỉnh, cải cách"], ["permit", "giấy phép"], ["demand", "nhu cầu, yêu cầu"], ["effort", "nỗ lực"], ["regulation", "quy định"], ["handle", "xử lý, giải quyết"], ["personnel", "nhân sự"], ["release", "tung ra, ra mắt, phát hành"], ["delay", "sự trì hoãn, trì hoãn"], ["edit", "chỉnh sửa, biên tập"], ["recommendation", "sự đề xuất"], ["supervise", "giám sát"], ["method", "phương pháp"], ["extend", "kéo dài, mở rộng"], ["response", "sự phản hồi"], ["division", "bộ phận"], ["reach", "vươn tới, đạt được"], ["maintain", "duy trì"], ["solution", "giải pháp"], ["accommodate", "chứa được, đáp ứng"], ["potential", "tiềm năng"], ["retire", "nghỉ hưu"], ["recruit", "tuyển dụng"], ["committee", "ủy ban"], ["office supplies", "văn phòng phẩm"], ["advantage", "lợi thế"], ["authorize", "ủy quyền, cho phép"], ["various", "đa dạng"], ["maintenance", "việc bảo dưỡng"], ["guarantee", "sự đảm bảo, đảm bảo"], ["establish", "thành lập"], ["fortunate", "may mắn"], ["agreement", "sự thỏa thuận, hợp đồng"], ["sample", "mẫu thử"], ["promptly", "một cách nhanh chóng"], ["valid", "có hiệu lực"], ["inspect", "kiểm tra"], ["remove", "loại bỏ"], ["be aware", "biết, nhớ, lưu ý"], ["implement", "ban hành"], ["ceremony", "buổi lễ"], ["take advantage of", "tận dụng, lợi dụng"], ["efficient", "hiệu quả"], ["acquire", "mua lại"], ["satisfaction", "sự thỏa mãn"], ["headquarters", "trụ sở"]
            ]),
            Image39: makeImageVocabSet("Từ ảnh - Trang 39", [
                ["acquisition", "việc mua lại"], ["donation", "việc hiến tặng, đóng góp"], ["complimentary", "miễn phí, cho, tặng"], ["approximately", "khoảng, xấp xỉ"], ["appropriate", "phù hợp"], ["campaign", "chiến dịch"], ["plant", "nhà máy"], ["entrance", "lối vào"], ["device", "thiết bị"], ["fair", "hội chợ, công bằng"], ["revise", "chỉnh sửa"], ["apply", "nộp đơn, ứng cử, áp dụng"], ["demonstrate", "trình diễn, chạy thử"], ["affect", "làm ảnh hưởng, tác động đến"], ["standard", "tiêu chuẩn"], ["eligible for", "đủ điều kiện, phù hợp"], ["alternative", "sự thay thế, xen nhau"], ["dedication", "sự tận tâm, cống hiến"], ["dedicated to", "tận tâm, cống hiến"], ["honor", "vinh danh"], ["equip", "trang bị"], ["comply with", "tuân thủ"], ["celebrate", "ăn mừng"], ["situation", "tình huống"], ["defect", "lỗi, sự hỏng hóc"], ["negotiate", "đàm phán"], ["temporary", "tạm thời"], ["examine", "kiểm tra"], ["merchandise", "hàng hóa"], ["familiarize", "tự làm quen với"], ["recover", "phục hồi"], ["individual", "cá nhân, riêng lẻ"], ["specify", "nói rõ, nêu cụ thể"], ["brief", "ngắn gọn"], ["accurate", "chính xác"], ["merger", "sự sáp nhập"], ["reputation", "danh tiếng"], ["secure", "chắc chắn, đảm bảo"], ["journal", "báo, tạp chí"], ["adjust", "điều chỉnh"], ["innovative", "đổi mới, sáng tạo"], ["publication", "ấn phẩm"], ["initial", "ban đầu"], ["volunteer", "tình nguyện viên, tình nguyện"], ["prevent", "ngăn ngừa"], ["properly", "đúng cách"], ["council", "hội đồng"], ["track", "dấu vết, theo dõi"], ["reception", "buổi tiếp đãi"], ["proper", "đúng đắn, phù hợp"], ["relocate", "chuyển chỗ"], ["accompany", "đi kèm với"], ["warehouse", "nhà kho"], ["revenue", "doanh thu"], ["experience", "kinh nghiệm, trải nghiệm"], ["occur", "xảy ra"], ["admission", "sự nhận vào, vé vào cửa"], ["destination", "điểm đến"], ["reasonable", "hợp lí"], ["qualification", "bằng cấp, trình độ"], ["predict", "dự đoán"], ["identification", "chứng minh thư"], ["peak", "đỉnh, đạt tối đa"], ["decline", "giảm"], ["route", "tuyến đường"], ["transfer", "chuyển"], ["conclude", "kết luận"], ["recall", "thu hồi"], ["obtain", "lấy, có được"], ["productivity", "năng suất"], ["shuttle", "xe trung chuyển"], ["express", "bày tỏ"], ["postpone", "trì hoãn"], ["anticipate", "trông đợi"], ["patient", "bệnh nhân, kiên nhẫn"], ["impact", "tác động, va chạm"], ["restrict", "hạn chế"], ["urgent", "cấp bách"], ["commitment to", "sự tận tâm, cam kết"], ["manual", "sách hướng dẫn"]
            ]),
            Image40: makeImageVocabSet("Từ ảnh - Trang 40", [
                ["capacity", "sức chứa, công suất"], ["affordable", "rẻ, có thể chi trả được"], ["prove", "chứng tỏ, tỏ ra"], ["enhance", "tăng cường, cải thiện"], ["confidential", "bí mật"], ["cautious", "cẩn trọng"], ["convention", "hội nghị"], ["occasion", "dịp"], ["appoint", "bổ nhiệm, chỉ định"], ["figures", "số liệu"], ["emphasis", "sự nhấn mạnh"], ["eager", "háo hức"], ["appliance", "thiết bị"], ["fix", "sửa"], ["retain", "giữ lại"], ["exceed", "vượt quá"], ["locate", "tìm thấy, định vị"], ["professionals", "chuyên viên"], ["institution", "tổ chức"], ["outstanding", "tuyệt vời, xuất sắc"], ["recipient", "người nhận"], ["substantial", "đáng kể"], ["relatively", "tương đối, khá là"], ["direction", "hướng đi"], ["oversee", "giám sát"], ["committed to", "tận tâm, cam kết"], ["comprehensive", "hoàn chỉnh, đầy đủ"], ["prohibit", "cấm"], ["measure", "sự đo lường, đo lường"], ["draft", "bản thảo"], ["essential", "cần thiết"], ["sharply", "một cách nhanh chóng"], ["conflict", "mâu thuẫn"], ["belongings", "đồ đạc"], ["transaction", "giao dịch"], ["vacancy", "vị trí trống, chỗ còn trống"], ["regardless of", "bất kể, không quan tâm đến"], ["interruption", "sự gián đoạn"], ["reward", "phần thưởng"], ["specification", "thông số"], ["precise", "chính xác"], ["license", "giấy phép"], ["commute", "đi làm, di chuyển"], ["considerable", "đáng kể"], ["fare", "tiền vé tàu xe"], ["contest", "cuộc thi"], ["proceed", "tiến triển, tiếp tục"], ["defective", "bị lỗi"], ["circumstance", "tình huống"], ["shortly", "sớm, trong thời gian ngắn"], ["consistently", "một cách đều đặn, nhất quán"], ["rapidly", "một cách nhanh chóng"], ["finalize", "hoàn tất, hoàn thành"], ["fulfill", "đáp ứng, hoàn thành"], ["undergo", "trải qua"], ["timely", "kịp thời"], ["disruption", "sự gián đoạn"], ["utilize", "sử dụng"], ["spacious", "rộng rãi"], ["shift", "ca làm việc"], ["proficient", "tài giỏi, thành thạo"], ["crowded", "đông đúc"], ["professionalism", "sự tác phong chuyên nghiệp"], ["banquet", "buổi tiệc"], ["costly", "tốn kém"], ["occasionally", "thỉnh thoảng"], ["ongoing", "đang diễn ra"], ["informative", "hữu ích, chứa nhiều thông tin"], ["debt", "nợ"], ["in charge of", "chịu trách nhiệm"], ["in response to", "để đáp lại"], ["extensive", "sâu rộng, rộng lớn"], ["reimburse", "hoàn tiền"], ["reliable", "đáng tin cậy"], ["procedure", "quy trình, thủ tục"], ["hand in", "nộp"], ["make it", "đến, làm được"], ["those who", "những người mà"], ["equal to", "bằng với"], ["come up with", "nghĩ ra"]
            ])
        };
